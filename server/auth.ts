...
export function registerAuthRoutes(app: Express) {
  app.post("/api/admin/login", async (req, res) => {
    try {
      ...
      console.log("[login] Session saved for:", admin.username, "| SID:", req.sessionID);
  ...
  app.get("/api/admin/me", (req, res) => {
    console.log("[/api/admin/me] cookies:", req.headers.cookie);
    console.log("[/api/admin/me] session:", req.session);
